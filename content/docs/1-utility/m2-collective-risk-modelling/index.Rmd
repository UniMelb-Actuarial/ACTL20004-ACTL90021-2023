...
output_name <- "23-GIM-M2-lec" # change latest slides below, too!
...
[^1]: References: Chapter 2.1-2.2 of @Wut20 | $\; \rightarrow$ [\textcolor{blue}{\underline{latest slides}}](https://gim-am3.netlify.app/output/23-GIM-M2-lec.pdf) 
