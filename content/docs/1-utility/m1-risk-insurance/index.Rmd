...
par(cex=1.4)
curve(umbrella(x),from=0.01,to=0.99,lwd=2,col="blue",xlab="gamma",ylab="Uncertainty equivalent")
...
- mean-variance portfolio theory (see @Jos13 and also ACTLxxxx) --- this is very similar to using a quadratic utility function
