...
- With respect to some sort of objective criteria.
  ...
  - This has been done a lot more rigorously only very recently by [@AvLiWoXi23](https://arxiv.org/abs/2206.08541), which was awarded the 2023 Hachemeister Prize by the American Casualty Actuarial Society (CAS).
...
- It is equivalent to apply $z(i)$ on incurred amounts (see @Tay00)

## Choice of credibility weights

### Bornhuetter-Ferguson

@BoFe72 suggested the most simple approach, to use either
