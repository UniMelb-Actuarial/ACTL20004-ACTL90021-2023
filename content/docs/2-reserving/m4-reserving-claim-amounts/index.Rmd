...
You can think of the evolution of a claim cost as two parallel paths; consider those two examples (Figure 2 of @AvTaWa23):

```{r fig.align='center',out.width="100%", echo=F}
include_graphics("claim_history.pdf")
```
